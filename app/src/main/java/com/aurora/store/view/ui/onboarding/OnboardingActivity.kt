...
class OnboardingActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!isDefaultPrefLoaded) {
            ...
            Preferences.putBoolean(this, Preferences.PREFERENCE_TOS_READ, true)
            Preferences.putBoolean(this, Preferences.PREFERENCE_INTRO, true)
        }
    ...
    private fun loadDefaultPreferences() {
        ...
        /*Network*/
        save(PREFERENCE_INSECURE_ANONYMOUS, true)

        /*Customization*/
        save(PREFERENCE_THEME_TYPE, 0)
        save(PREFERENCE_THEME_ACCENT, 3)
